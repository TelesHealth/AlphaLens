  ...
  recommendations: zod
    .array(
      zod.object({
        ...
        assetPriceAtCall: zod.number().nullish(),
        edge: zod.number().nullish(),
        edgeType: zod
          .enum(["probability_gap", "directional_conviction"])
          .nullish(),
        ...
        edgeChangeAlert: zod
          .object({
            ...
            direction: zod.enum(["widening", "narrowing"]).optional(),
            change: zod.number().optional(),
            previousEdge: zod.number().optional(),
            currentEdge: zod.number().optional(),
            minutesAgo: zod.number().optional(),
...
export const UpdateRecommendationOutcomeResponse = zod.object({
  recommendation: zod.object({
    ...
    assetPriceAtCall: zod.number().nullish(),
    edge: zod.number().nullish(),
    edgeType: zod.enum(["probability_gap", "directional_conviction"]).nullish(),
    convictionScore: zod.number().nullish(),
    edgeCalculatedAt: zod.date().nullish(),
    edgeAgeMinutes: zod.number().nullish(),
    edgeExplanation: zod.string().nullish(),
...
export const GetLeaderboardResponse = zod.object({
  stats: zod.object({
    ...
    avgConvictionScore: zod.number().optional(),
    highConvictionWinRate: zod.number().nullish(),
