...
function RecommendationRow({ rec }: { rec: Recommendation }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="col-span-2 xl:col-span-1 text-xs font-mono text-muted-foreground">
          {fmtDate(rec.createdAt)}
        </div>
        <div className="col-span-10 xl:col-span-3 min-w-0">
        ...
        <div className="hidden xl:block xl:col-span-1 text-right font-mono text-xs">
          {fmtNumber(rec.aiProbability)}%
        </div>
        <div className="hidden xl:block xl:col-span-1 text-right font-mono text-xs text-muted-foreground">
        ...
        <div className="hidden xl:block xl:col-span-1 text-right pr-2 font-mono text-xs text-muted-foreground">
          {fmtNumber(rec.confidence, 0)}
        </div>
        <div className="col-span-6 xl:col-span-1 flex xl:justify-center xl:pl-2">
          <OutcomeBadge outcome={rec.outcome} />
        </div>
        <div className="col-span-4 xl:col-span-1 text-right font-mono text-xs">
          {rec.outcome ? (
        ...
        {stats && (
          <>
            ...
            <div className="rounded-2xl border border-border bg-card/40 backdrop-blur-sm">
              ...
              {/* Header row (desktop) */}
              <div className="hidden xl:grid grid-cols-12 gap-2 px-3 py-2 text-[10px] font-mono uppercase tracking-wider text-muted-foreground border-b border-border/40">
